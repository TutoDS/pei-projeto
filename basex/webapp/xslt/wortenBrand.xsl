    ...
    <xsl:template match="/">
        ...
        <body>
            <header>
                ...
                <div class="navbar navbar-dark shadow-sm" style="background-color:e41a15">
                    <div class="container d-flex justify-content-between">
                        ...
                        <div class="text-right">
                            ...
                            <a href="/worten" class="text-white font-weight-bold mr-4">
                                Worten
                            </a>

                            <a href="/fnac" class="text-white">
                                Fnac
                            </a>
                        </div>
                    </div>
            ...
            <section class="jumbotron text-center"
                ...
                <div class="container pt-5 pb-5 text-white" style="background-color: rgba(55,55,55,0.75)">
                    <h3>Lista de Smartphones da marca <span class="ml-1">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body pt-2 pb-2" style="height: 200px;">
                                                ...
                                                <div class="card-text mt-1 mb-1">
                                                    ...
                                                    <a href="/worten/{brand}"><xsl:value-of select="brand" /></a>
                                                </div>
                                                <div class="card-text mt-1 mb-1">
                                                    <span class="font-weight-bold mr-1">
